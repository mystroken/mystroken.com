...
const Layout = ({ children }) => {
  ...
  useEffect(() => {
    layoutContainer.current && Scrollbar.init(layoutContainer.current)
  }, [])
  ...
  return (
    <Fragment>
      <nav className="menu">
        ...
        <div className="menu-toggle">
          <button className="toggle-btn">
            <span className="toggle-btn__box">
              <span className="toggle-btn__line"></span>
              <span className="toggle-btn__line"></span>
            </span>
          </button>
        </div>
      ...
      <div id="view" className="view" role="main">
        <canvas id="scene" className="scene" />
        <div ref={layoutContainer} id="layout" className="layout">
          {children}
          <footer id="footer" className="footer">
            <div className="footer__inner">
              ...
              {` `}
              And <a href="https://wordpress.org/">WordPress</a>. The source code
              is hosted on
              {` `}
